...
The `DataManager` acts as the interface between the service endpoint and the React Dropdown Tree and requires the following information to interact with the service endpoint correctly.
