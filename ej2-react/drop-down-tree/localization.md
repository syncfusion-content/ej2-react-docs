...
The following table represents the default localization keys and their corresponding text messages for the React Dropdown Tree in `en` culture. These keys serve as templates that display dynamic content and can be customized for any target locale:
