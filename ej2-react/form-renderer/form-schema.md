---
layout: post
title: Form Schema in React Form Renderer Component | Syncfusion
description: Learn here all about the JSON schema structure that drives the Syncfusion React Form Renderer component of Syncfusion Essential JS 2 and more.
control: Form Schema
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
# Form Schema in React Form Renderer component
