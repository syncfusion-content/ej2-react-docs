...
| [`MultiLevelLabel`](https://ej2.syncfusion.com/react/documentation/api/chart/index-default#multilevellabelmodule) | Inject this module to use the multi-level label feature. |
