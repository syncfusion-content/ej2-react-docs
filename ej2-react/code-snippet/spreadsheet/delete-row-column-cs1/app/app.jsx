...
export default class App extends React.Component {
    ...
    ;
    render() {
        return (<div> <SpreadsheetComponent ref={(ssObj) => { this.spreadsheet = ssObj; }} created={this.created.bind(this)} showRibbon={false} showFormulaBar={false} allowDelete={true}>
                        <SheetsDirective>
