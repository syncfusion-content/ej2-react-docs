...
export default class App extends React.Component {
    spreadsheet;
    styles = { verticalAlign: 'middle', textAlign: 'center', fontSize: '16pt', fontWeight: 'bold',
    ...
    ;
    render() {
        return (<div> <SpreadsheetComponent ref={(ssObj) => { this.spreadsheet = ssObj; }} created={this.oncreated.bind(this)} showSheetTabs={false} showFormulaBar={false} allowInsert={false} allowDelete={false}>
                        <SheetsDirective>
