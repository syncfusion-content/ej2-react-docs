...
function ReactApp() {
  ...
  let expandInstance: DropDownListComponent;
  let collapseInstance: DropDownListComponent;
  const expandAni: string[] = ['SlideDown', 'SlideUp', 'FadeIn', 'FadeOut', 'FadeZoomIn', 'FadeZoomOut', 'ZoomIn', 'ZoomOut', 'None'];
  ...
  } let collapseAnimationChange = (e: ChangeEventArgs): void => {

    acrdnInstance.animation.collapse = { effect: collapseInstance.value as Effect }
  }
  let expandAnimationChange = (e: ChangeEventArgs): void => {
    acrdnInstance.animation.expand = { effect: expandInstance.value as Effect }
  }
