...
function ReactApp() {
  ...
  let dropInstance: DropDownListComponent;
  ...
  const onChange = () => {
    tabInstance.heightAdjustMode = dropInstance.value as HeightStyles;
  }

  return (
    <div>
      <DropDownListComponent ref={drop => dropInstance = drop!} id='contentHeight' dataSource={heightData} fields={fields} value={value} width={'150'} change={onChange} />
      <br /><br />
      <TabComponent ref={tab => tabInstance = tab!} height="400px">
        <TabItemsDirective>
