...
function ReactApp() {
    ...
    function onBeforeRender(args) {
        if (args.target) {
            setContent(`<div>` + args.target.innerText + `</div>`);
        }
    }
    ...
    return (<TooltipComponent id="template-tootip" content={content} target=".e-toolbar-item" beforeRender={onBeforeRender} position={'TopCenter'}>
