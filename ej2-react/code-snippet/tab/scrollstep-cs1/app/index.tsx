  ...
  return (
    <div>
      <TabComponent height="250px" scrollStep={50}>
        <TabItemsDirective>
          <TabItemDirective header={{ text: "HTML" }} content={content0} />
          <TabItemDirective header={{ text: "C Sharp(C#)" }} content={content1} />
          <TabItemDirective header={{ text: "Java" }} content={content2} />
          <TabItemDirective header={{ text: "VB.Net" }} content={content3} />
          <TabItemDirective header={{ text: "Xamarin" }} content={content4} />
          <TabItemDirective header={{ text: "ASP.NET" }} content={content5} />
          <TabItemDirective header={{ text: "ASP.NET MVC" }} content={content6} />
          <TabItemDirective header={{ text: "JavaScript" }} content={content7} />
        </TabItemsDirective>
      </TabComponent>
    </div>
  );
