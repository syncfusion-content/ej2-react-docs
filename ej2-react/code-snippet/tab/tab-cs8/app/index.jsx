...
function App() {
    let tabInstance = new TabComponent({});
    ;
    let dropdownData = [
        { text: 'HTML', Id: 0 },
        { text: 'C-Sharp(C#)', Id: 1 },
    ...
    return (<div>
      ...
      <TabComponent heightAdjustMode='Auto' selecting={selecting} ref={(tab) => tabInstance = tab} selected={selected}>
        <TabItemsDirective>
