...
function ReactApp() {
    let headerText = [{ text: "Twitter", iconCss: 'e-twitter' }, { text: "Facebook", iconCss: 'e-facebook' }, { text: "WhatsApp", iconCss: 'e-whatsapp' }];
    let tabInstance;
    let dropInstance;
    ...
    const onChange = () => {
        let items = tabInstance.items;
        for (let i = 0; i < items.length; i++) {
            items[i].header.iconPosition = dropInstance.value;
        }
        ;
    };
    return (<div>
      <DropDownListComponent ref={drop => dropInstance = drop} id='headerStyles' dataSource={headerData} fields={fields} value={value} width={'150'} change={onChange}/>
      <br /><br />
