...
const App = () => {
  ...
  const [trgIndex, setrgIndex] = useState<number>(0);
  ...
  let updateCollapseClass = (index: number): void => {
    ...
    const cntEle: any = tabInstance.current.element.querySelector("#e-content-element_" + index);
  ...
  const tabSelected = (e: SelectEventArgs): void => {
    ...
    let cnttrgs: NodeListOf<Element> = tabInstance.current.element.querySelectorAll('#element.e-tab > .e-content > .e-item');
