...
const ReactApp = () => {
  let headerText: any = [{ text: "HTML" }, { text: "C Sharp(C#)" }, { text: "Java" }, { text: "VB.Net" }, { text: "Xamarin" }, { text: "ASP.NET" }, { text: "ASP.NET MVC" }, { text: "JavaScript" }];
  ...
  return (
    <TabComponent heightAdjustMode='Auto' overflowMode='Scrollable'>
      <TabItemsDirective>
        ...
        <TabItemDirective header={headerText[3]} content={vbcNetContent} />
