...
function ReactApp() {
    ...
    const changeHeaderStyles = (e) => {
        removeStyleClass();
        const name = document.getElementById('headerStyles').value;
        if (name === 'Fill') {
    ...
    return (<div>
        <DropDownListComponent id='headerStyles' dataSource={headerData} fields={fields} value={hdrVal} width={'150'} change={changeHeaderStyles}/>
        <br /><br />
        <TabComponent heightAdjustMode='Auto' height={320} ref={tab => tabObj = tab}>
          <TabItemsDirective>
