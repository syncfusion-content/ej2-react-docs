...
const ReactApp = () => {
  ...
  const previousInstance = useRef<DropDownListComponent>(null);
  const nextInstance = useRef<DropDownListComponent>(null);
  ...
  let previousAnimationChange = (): void => {
    tabInstance.current.animation.previous = { effect: previousInstance.current.value as Effect };
  }
  let nextAnimationChange = (): void => {
    tabInstance.current.animation.next = { effect: nextInstance.current.value as Effect };
  }
