...
const ReactApp = () => {
  ...
  const previousInstance = useRef(null);
  const nextInstance = useRef(null);
  let animationData = ['SlideLeftIn', 'SlideRightIn', 'FadeIn', 'FadeOut', 'FadeZoomIn', 'FadeZoomOut', 'ZoomIn', 'ZoomOut', 'None'];
  useEffect(() => {
  ...
  let previousAnimationChange = () => {
    tabInstance.current.animation.previous = { effect: previousInstance.current.value };
  }
  let nextAnimationChange = () => {
    tabInstance.current.animation.next = { effect: nextInstance.current.value };
  }
  ...
  return (
    <div style={wrapStyle}>
      <div className='row'>
        ...
        <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
          <DropDownListComponent ref={previousInstance} index={0} change={previousAnimationChange} dataSource={animationData} popupHeight="250px" placeholder="Select Previous animation" />
        </div>
      </div>
      <div className='row'>
        <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
        ...
        <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
          <DropDownListComponent ref={nextInstance} index={0} change={nextAnimationChange} dataSource={animationData} popupHeight="250px" placeholder="Select Next animation" />
        </div>
      </div>
      <TabComponent ref={tabInstance}>
        <TabItemsDirective>
