...
function App() {
    ...
    return (
        ...
        <ChatUIComponent user={currentUserModel} enableAttachments={true} attachmentSettings= {attachmentSettings} attachmentUploadFailure={attachmentUploadFailure} ></ChatUIComponent>
    );
}
