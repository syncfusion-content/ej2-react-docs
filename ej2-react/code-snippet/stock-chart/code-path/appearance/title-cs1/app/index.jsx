...
function App() {
    ...
    const titlestyle = { fontFamily: "Arial", color: '#424242 ' };
    const tooltip = { enable: true };
    return <StockChartComponent id='stockcharts' primaryXAxis={primaryxAxis} primaryYAxis={primaryyAxis} tooltip={tooltip} crosshair={crosshair} height='350' title='AAPL Stock Price' titleStyle={titlestyle}>
