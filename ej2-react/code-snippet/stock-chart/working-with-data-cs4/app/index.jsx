...
function App() {
    let chartInstance = React.useRef<StockChartComponent>(null);
...
#syncfusionButtonContainer {
    margin-top: 5px;
          ...
          const loadData = () => {
              if (chartInstance.current) {
                  chartInstance.current.series[0].dataSource = chartData;
    ...
    <div>
            ...
            <div id="chart-container">
                <StockChartComponent id='stockchart' loaded={loadedChartData} noDataTemplate={noDataTemplate} primaryXAxis={{
            valueType: 'DateTime',
        ...
        }} title='Sales Analysis' bearFillColor='#2ecd71' bullFillColor='#e74c3d' height='350'>
            ...
            AccumulationDistributionIndicator, MacdIndicator, StochasticIndicator]}/>
                <StockChartSeriesCollectionDirective>
                    <StockChartSeriesDirective dataSource={hasData ? chartData: []} type='Candle' animation={{ enable: true }}>
