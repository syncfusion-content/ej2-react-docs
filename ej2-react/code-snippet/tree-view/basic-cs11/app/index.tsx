...
function App() {
  ...
  let countries: { [key: string]: Object }[] = [
    ...
    let fields: Object = { dataSource: countries, id: 'id', parentID: 'pid', text: 'name', hasChildren: 'hasChild', selected: 'isSelected' };
    // set the Multi Selection option to TreeView
    let allowMultiSelection: boolean = true;
    let selectedNodes: string[] = ['2','6'];
    ...
    return (
        ...
        <TreeViewComponent fields={fields} allowMultiSelection={ allowMultiSelection } selectedNodes={ selectedNodes } nodeSelected={nodeSelected}/>
    );
}
export default App;
