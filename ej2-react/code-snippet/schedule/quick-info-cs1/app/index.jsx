...
function App() {
    ...
    return (<ScheduleComponent id="schedule" ref={(schedule) => (scheduleObj = schedule)} width="100%" height="550px" selectedDate={new Date(2018, 1, 15)} eventSettings={{ dataSource: data }} quickInfoTemplates={{ header: header.bind(this), content: content.bind(this), footer: footer.bind(this) }}>
