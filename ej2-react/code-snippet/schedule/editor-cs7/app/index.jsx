...
function App() {
    ...
    return (<ScheduleComponent width='100%' height='550px' selectedDate={new Date(2018, 1, 15)} ref={schedule => scheduleObj = schedule} eventSettings={{ dataSource: data }} editorTemplate={editorTemplate} popupOpen={onPopupOpen} showQuickInfo={false}>
    <ViewsDirective>
