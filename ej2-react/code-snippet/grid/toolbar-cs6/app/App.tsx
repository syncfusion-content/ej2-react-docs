      ...
      return (<div className="control-pane">
        ...
        <GridComponent id="Grid" dataSource={data.slice(0, 8)} ref={(g) => (grid = g)} toolbar={toolbarOptions} created={created}>
            <ColumnsDirective>
                ...
                <ColumnDirective field='Freight' headerText='Freight' type='number' format='C2'  width='120'/>
                <ColumnDirective field='OrderDate' headerText='Order Date' type='date' format='yMd' width='140'/>
            </ColumnsDirective>
