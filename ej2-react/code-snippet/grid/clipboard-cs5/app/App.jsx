...
function App() {
    ...
    return (<div>
      <GridComponent dataSource={data} allowPaging={true} allowSorting={true} allowExcelExport={true} allowPdfExport={true} contextMenuItems={contextMenuItems} editSettings={editing} allowGrouping={true} groupSettings={groupOptions}>
        <ColumnsDirective>
