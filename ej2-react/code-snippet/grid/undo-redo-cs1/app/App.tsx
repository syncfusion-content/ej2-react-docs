...
import { Edit, Toolbar, Page, ToolbarItems } from '@syncfusion/ej2-react-grids';
import * as React from 'react';
import { inventoryStoreData } from './datasource';

function App() {
    const editOptions: EditSettingsModel = { allowEditing: true, allowAdding: true, allowDeleting: true, mode: 'Batch', enableUndoRedo: true };
    const toolbarOptions: ToolbarItems[] = ['Add', 'Delete', 'Update', 'Cancel', 'Undo', 'Redo'];
    const idRules: object = { required: true };
    const unitPriceRules: object = { required: true, min: 1 };
