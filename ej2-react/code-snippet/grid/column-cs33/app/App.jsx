...
function App() {
    ...
    <ButtonComponent onClick={removeColumn}>Remove Columns</ButtonComponent><GridComponent id="Grid" dataSource={data} allowPaging={true} enablePersistence={true} dataBound={dataBound} height={230} ref={g => grid = g}>
        <ColumnsDirective>
