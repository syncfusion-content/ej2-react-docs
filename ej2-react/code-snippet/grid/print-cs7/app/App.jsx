...
import { GridComponent, ColumnsDirective, ColumnDirective, Selection, Inject, Toolbar } from '@syncfusion/ej2-react-grids';
...
function MasterDetail() {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <GridComponent dataSource={master} selectedRowIndex={1} toolbar={['Print']} rowSelected={rowselect}  beforePrint={beforePrint}>
                    <ColumnsDirective>
