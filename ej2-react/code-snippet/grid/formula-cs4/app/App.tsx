...
import { GridComponent, ColumnsDirective, ColumnDirective, Inject, Edit, Formula, EditSettingsModel, SelectionSettingsModel, FormulaSettingsModel } from '@syncfusion/ej2-react-grids';
import { productData } from './datasource';

function App() {
    const formulaSettings: FormulaSettingsModel = {
        customFunctions: {
            CUSTOMSUM: (params: { values: number[] }) => {
                let total = 0;
