...
function App() {
    ...
    return (<div>
        <DialogComponent ref={(scope) => { dialog = scope; }} width='250px' id='dialog' content='Move Items To "Web Team"' header='Move Items' buttons={alertDlgButtons} position={position} visible={false} />
