...
function App() {
        ...
        if (e.which === 13) {
            ...
            if (pageNumber > editorPageCount) {
                ...
                if (documenteditor.selection) {
                    documenteditor.selection.goToPage(
                        parseInt(editablePageNumber.textContent, 0)
                    );
                } else {
    ...
    function updateZoomContent() {
        zoom.content = Math.round(this.documenteditor.zoomFactor * 100) + '%';
    }
    ...
    return (
        <div>
            ...
            <div id="page-fit-type-div">
                ...
                <DropDownButtonComponent ref={scope => { zoom = scope; }} items={items} cssClass="e-de-statusbar-zoom" select={onZoom}>                        100%          </DropDownButtonComponent>
            </div>
        </div>
    );
}
