...
function App() {
  ...
  const groupButtonSettingsProps = {
    selection: RibbonGroupButtonSelection.Single,
    items: [
        {iconCss: 'e-icons e-bold', keyTip: '1', content: 'Bold', selected: true},
        {iconCss: 'e-icons e-italic', keyTip: '2', content: 'Italic'},
        {iconCss: 'e-icons e-underline', keyTip: '3', content: 'Underline'},
        {iconCss: 'e-icons e-strikethrough', keyTip: '4', content: 'Strikethrough'},
        {iconCss: 'e-icons e-change-case', keyTip: '5', content: 'Change Case'}
    ]
  }
  return (
      <div>
                      ...
                      <RibbonGroupsDirective>
                        ...
                        <RibbonGroupDirective header="Font" keyTip='FB' overflowHeader="More Font Options" groupIconCss="e-icons e-bold" isCollapsible={false} enableGroupOverflow={true} orientation="Row" cssClass='font-group'>
                            <RibbonCollectionsDirective>
                                ...
                                <RibbonCollectionDirective>
                                    <RibbonItemsDirective>
                                        <RibbonItemDirective type="GroupButton" keyTip='GB' allowedSizes={RibbonItemSize.Small} groupButtonSettings={groupButtonSettingsProps}>
                                        </RibbonItemDirective>
