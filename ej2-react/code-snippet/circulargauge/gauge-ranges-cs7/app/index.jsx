...
export function App() {
    return (<CircularGaugeComponent id='circulargauge' title='Short Put Distance' titleStyle={{ size: '18px' }} centerY="57%'">
    <Inject services={[Annotations, Gradient]}/>
     <AxesDirective>
        ...
        }} majorTicks={{ width: 0 }} minorTicks={{ width: 0 }} labelStyle={{ font: { size: '0px' } }}>
         <PointersDirective>
          ...
          <RangesDirective>
            <RangeDirective start={0} end={12} radius='115%' color='#01aebe' startWidth={25} endWidth={25} linearGradient={{
            ...
            <RangeDirective start={0} end={11} radius='85%' color='#3bceac' startWidth={25} endWidth={25} linearGradient={{
            startValue: '0%', endValue: '100%',
            colorStop: [
                { color: '#9E40DC', offset: '0%', opacity: 0.9 },
                { color: '#E63B86', offset: '70%', opacity: 0.9 }
            ...
            <RangeDirective start={0} end={10} radius='55%' color='#ee4266' startWidth={25} endWidth={25} linearGradient={{
            startValue: '0%', endValue: '100%',
            colorStop: [
                { color: '#9E40DC', offset: '0%', opacity: 0.9 },
                { color: '#E63B86', offset: '70%', opacity: 0.9 }
