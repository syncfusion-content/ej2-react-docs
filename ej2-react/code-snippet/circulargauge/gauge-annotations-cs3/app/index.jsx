...
import { CircularGaugeComponent, AxesDirective, AxisDirective, PointersDirective, PointerDirective, Inject, Annotations, AnnotationsDirective, AnnotationDirective, RangesDirective, RangeDirective } from '@syncfusion/ej2-react-circulargauge';
...
export function App() {
    ...
    return (<CircularGaugeComponent id='circulargauge' loaded={loadRender}>
    ...
    <AxesDirective>
      <AxisDirective minimum={0} maximum={12} startAngle={0} endAngle={360} lineStyle={{ width: 0 }} labelStyle={{
        ...
        <PointersDirective>
            ...
            <PointerDirective radius='70%' pointerWidth={4} value={9.8} color='rgba(168,145,102,1)' cap={{
