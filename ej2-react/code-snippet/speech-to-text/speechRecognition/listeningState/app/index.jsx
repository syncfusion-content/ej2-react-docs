...
function App() {
    const [listeningState, setListeningState] = useState('Inactive');
    ...
    return (
        <div id='container'>
            ...
            <SpeechToTextComponent
                onStart={(args) => updateListeningState(args.listeningState)}
                onStop={(args) => updateListeningState(args.listeningState)}
