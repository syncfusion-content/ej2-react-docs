...
let azureOpenAIApiKey = ''; // Your_Azure_OpenAI_API_Key
let azureOpenAIEndpoint = ''; // Your_Azure_OpenAI_Endpoint
let azureOpenAIApiVersion = ''; // Your_Azure_OpenAI_API_Version
let azureDeploymentName = ''; // Your_Deployment_Name
