        ...
        return (<div className='control-pane'>
                <div className='control-section' id="rteTools">
                    <div className='rte-control-section'>
                        <RichTextEditorComponent id="exportDocument" value={this.rteValue} toolbarSettings={this.toolbarSettings} enableXhtml={true}  ref={(richtexteditor) => {this.editorObj = richtexteditor;}}>
