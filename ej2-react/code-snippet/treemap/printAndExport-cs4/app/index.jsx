...
export class App extends React.Component {
    ...
    render() {
        return (<div>
    <ButtonComponent value='Export' onClick={this.click.bind(this)}>Export</ButtonComponent> <TreeMapComponent id='treemap' allowPdfExport={true} ref={g => this.treemap = g} dataSource={[
