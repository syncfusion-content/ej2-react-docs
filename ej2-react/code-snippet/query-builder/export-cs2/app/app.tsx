...
import { ColumnsModel, QueryBuilderComponent, QueryLibrary, RuleModel } from '@syncfusion/ej2-react-querybuilder';
    ...
    return (
        <div>
            ...
            <div className="e-qb-button">
                <ButtonComponent id="exportmongo" cssClass='e-primary' content='Get MongoDB' onClick = {getSql}/>
