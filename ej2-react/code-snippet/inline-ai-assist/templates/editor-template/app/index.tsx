...
const App: React.FC = () => {
    ...
    const footerContent = () => {
        return (
            <div className="custom-footer">
                <textarea id="promptTextArea" className="e-input" rows={2} placeholder="Enter your prompt here"></textarea>
                <button id="sendPrompt" className="e-btn e-primary" onClick={() => {
                    const textArea = document.getElementById('promptTextArea') as HTMLTextAreaElement;
                    if (textArea && assistRef.current) {
    ...
    const handlePromptRequest = (): void => {
        setTimeout(() => {
