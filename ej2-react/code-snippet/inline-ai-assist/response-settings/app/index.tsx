import { InlineAIAssistComponent, ResponseItemModel, ResponseItemSelectEventArgs } from '@syncfusion/ej2-react-interactive-chat';
...
const App: React.FC = () => {
    ...
    const responseItems: ResponseItemModel[] = [
        {
            label: 'Regenerate',
