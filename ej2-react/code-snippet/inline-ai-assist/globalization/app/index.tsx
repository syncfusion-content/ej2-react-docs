...
interface ResponseItemSelectArgs {
    command: Command;
}
...
const App: React.FC = () => {
    ...
    const [enableRtl, setEnableRtl] = React.useState<boolean>(false);
    ...
    const handleResponseItemSelect = (args: ResponseItemSelectArgs): void => {
    ...
    const handleRtlToggle = (e: React.ChangeEvent<HTMLInputElement>): void => {
