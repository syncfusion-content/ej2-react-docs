...
import { RichTextEditorComponent, HtmlEditor, Toolbar, Image, Inject, Link, QuickToolbar } from "@syncfusion/ej2-react-richtexteditor";
...
class App extends React.Component {
    ...
    render() {
        ...
        <DialogComponent width="350px" isModal={true} visible={this.state.hideDialog} close={this.dialogClose} overlayClick={this.onOverlayClick} open={this.dlgopen}>
