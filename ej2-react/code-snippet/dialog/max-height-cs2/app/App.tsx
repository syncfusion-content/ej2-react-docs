...
function App(){
    ...
    <div className="App" id='dialog-target'>
        ...
        <DialogComponent header='Dialog' showCloseIcon={true} visible={false} width='800px' showCloseIcon ={true} target='#dialog-target' ref={dialog => dialogInstance = dialog!} created = {onCreated} beforeOpen = {onBeforeOpen}>
