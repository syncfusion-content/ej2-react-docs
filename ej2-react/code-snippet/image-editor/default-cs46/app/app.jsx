...
export default class App extends React.Component {
    ...
    render() {
        return (<div className='e-img-editor-sample'>
            <ImageEditorComponent ref={(img) => { this.imgObj = img; }} created={this.imageEditorCreated.bind(this)} beforeSave = {this.beforeSaved.bind(this)} saved = {this.saved.bind(this)}>
