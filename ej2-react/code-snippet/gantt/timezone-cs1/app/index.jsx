...
class App extends React.Component {
    ...
    render() {
        return <GanttComponent dataSource={this.timezoneData} taskFields={this.taskFields} timelineSettings={this.timelineSettings} allowSelection={true} timezone='UTC' height='450px' dateFormat='hh:mm a' dayWorkingTime={this.dayWorkingTime} durationUnit='Hour' includeWeekend={true}>
