                ...
                <div className="col-lg-12 col-sm-12 col-md-12">
                    <div className='main-header' id='header-section'>
                        <ul className='header-list'>
                            <li className='float-left header-style icon-menu' id='hamburger' onClick={toggleClick} ref={sidebar=>(sidbarToggle as any)=sidebar}></li>
                    ...
                    <SidebarComponent id="sidebar-treeview" ref={Sidebar => sidebarobj = Sidebar as SidebarComponent} width={width} target={target} mediaQuery={mediaQuery} style={{visibility:"hidden"}} created={onCreate} close={onClose} dockSize={dockSize} enableDock={true}>
