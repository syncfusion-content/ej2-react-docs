...
function App() {
    ...
    return (<div id="target" className="control-section splitter-expand">
          <SplitterComponent id="splitter1" separatorSize={3} height="350px" width="100%" ref={(splitter) => { innerSplitterInstance = splitter; }}>
          <PanesDirective>
              <PaneDirective size='48%' content={leftPaneContent}/>
              <PaneDirective />
          </PanesDirective>
          </SplitterComponent>
          <SplitterComponent id="splitter2" separatorSize={3} orientation="Vertical" ref={(splitter) => { splitterInstance = splitter; }} created={onCreate = onCreate.bind(this)}>
            <PanesDirective>
