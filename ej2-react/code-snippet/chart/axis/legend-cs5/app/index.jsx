...
class App extends React.Component {
    render() {
        return <ChartComponent id='charts' primaryXAxis={{ valueType: 'Category', title: 'Countries' }} primaryYAxis={{ minimum: 0, maximum: 80, interval: 20, title: 'Medals' }} legendSettings={{ visible: true, textStyle: { color: "red" } }}  title='Olympic Medals'>
