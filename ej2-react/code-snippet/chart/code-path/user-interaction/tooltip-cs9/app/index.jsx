...
function App() {
    return (<ChartComponent id='charts' primaryXAxis={{ title: 'Years', lineStyle: { width: 0 }, labelFormat: 'y',
            ...
            minimum: 0, maximum: 20, interval: 2 }} tooltip={{ enable: true,
            template: '<div style="background-color:lightblue"><div>${x}</div><div>${y}</div></div>' }} title='Unemployment Rates 1975-2010' titleStyle={{ fontFamily: "Arial", fontStyle: 'italic', fontWeight: 'regular',
