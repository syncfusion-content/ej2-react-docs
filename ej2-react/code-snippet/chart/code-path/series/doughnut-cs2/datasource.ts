...
export let centerData: object[] = [{ x: 'Chrome', y: 61.31, text: 'Chrome: 61.31%' },
                                    { x: 'Safari', y: 24.68, text: 'Safari: 24.68%' },
                                    { x: 'Edge', y: 5.00, text: 'Edge: 5.00%' },
                                    { x: 'Samsung Internet', y: 2.72, text: 'Samsung Internet: 2.72%' },
                                    { x: 'Firefox', y: 2.66, text: 'Firefox: 2.66%' },
                                    { x: 'Others', y: 3.63, text: 'Others: 3.63%' }
                                    ];
