...
function App() {
    ...
    return (<ChartComponent id='charts' primaryXAxis={{ title: 'Years', valueType: 'DateTime', labelFormat: 'yMMM',
            ...
            majorTickLines: { width: 0 } }} legendSettings={{ visible: false }} zoomSettings={{ enableSelectionZooming: true, toolbarItems: ['Zoom', 'Pan', 'Reset'] }} title='Sales History of Product X'>
    <Inject services={[AreaSeries, Legend, Tooltip, DataLabel, Zoom, DateTime]}/>
    <SeriesCollectionDirective>
        <SeriesDirective dataSource={data} xName='x' yName='y' name='Product X' opacity={0.6} type='Area' border={{ width: 0.5, color: '#00bdae' }} animation={{ enable: false }}>
        </SeriesDirective>
    </SeriesCollectionDirective>
  </ChartComponent>);
}
