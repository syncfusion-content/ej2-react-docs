...
export let categoryData: Object[] = [{ country: "Russia", gold: 50, silver: 70, bronze: 45 }, { country: "China", gold: 40, silver: 60, bronze: 55 },
...
export let stripData: Object[] = [{x: 1, y: 20},{x: 2, y: 22},{x: 3, y: 0},{x: 4, y: 12},{x: 5, y: 5},
...
export let stepAreaData: any[] = [
    { x: 1, y: 7, y1:10 }, { x: 2, y: 1, y1:5 }, { x: 3, y: 1, y1:7 },
    { x: 4, y: 14, y1:12 }, { x: 5, y: 1, y1:4 }, { x: 6, y: 10, y1:15 },
    { x: 7, y: 8, y1:12 }, { x: 8, y: 6, y1:10 }, { x: 9, y: 10, y1:14 },
    { x: 10, y: 10, y1:15 }, { x: 11, y: 16, y1:18 }, { x: 12, y: 6, y1:10 },
    { x: 13, y: 14, y1:18 }, { x: 14, y: 7, y1:11 }, { x: 15, y: 5, y1:9 },
    { x: 16, y: 2, y1:5 }, { x: 17, y: 14, y1:18 }, { x: 18, y: 7, y1:11 },
...
export let stackColumndata: any[] = [
