...
function App() {
  ...
  return <ChartComponent id='charts'
      ...
      <SeriesDirective dataSource={stackBarData} xName='x' yName='y' name='Apple' type='StackingBar100' border={border}>
        ...
        <SeriesDirective dataSource={stackBarData} xName='x' yName='y1' name='orange' type='StackingBar100' border={border}>
        </SeriesDirective>
        <SeriesDirective dataSource={stackBarData} xName='x' yName='y2' name='Wastage' type='StackingBar100' border={border}>
        </SeriesDirective>
      </SeriesCollectionDirective>
    </ChartComponent>
