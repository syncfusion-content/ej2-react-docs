...
function App() {
  ...
  return <ChartComponent id='charts'
      ...
      <SeriesDirective dataSource={stackBarData} xName='x' yName='y' dashArray='5' type='StackingBar' border={border} dashArray='3'>
        </SeriesDirective>
        <SeriesDirective dataSource={stackBarData} xName='x' yName='y1' dashArray='5' type='StackingBar' border={border} dashArray='3'>
        </SeriesDirective>
        <SeriesDirective dataSource={stackBarData} xName='x' yName='y2' dashArray='5' type='StackingBar' border={border} dashArray='3'>
        </SeriesDirective>
      </SeriesCollectionDirective>
    </ChartComponent>
