...
import { AxisModel, ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, Selection, Legend, LegendSeriesModel, Category, ScatterSeries } from '@syncfusion/ej2-react-charts';
...
function App() {
    ...
    var grid: Grid | null;
    function dragComplete(args: any): void {
    ...
    return (<div>
              <div>
                <div>
                <ChartComponent id='charts' primaryXAxis={primaryxAxis} primaryYAxis={primaryyAxis} title="Profit Comparision of A and B" selectionMode={selectionMode} legendSettings={legendSettings} dragComplete={dragComplete.bind(this)}>
