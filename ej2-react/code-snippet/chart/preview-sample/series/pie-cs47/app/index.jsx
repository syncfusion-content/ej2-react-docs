...
import { AccumulationChartComponent, AccumulationSeriesCollectionDirective, AccumulationSeriesDirective, PieSeries, Inject, Legend } from '@syncfusion/ej2-react-charts';
...
function App() {
    ...
    const handleLegendRender = (args) => {
        ...
        const matchedPoint = points?.filter((p) => p.x === args.text)[0];
