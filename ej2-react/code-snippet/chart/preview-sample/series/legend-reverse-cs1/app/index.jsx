...
function App() {
    ...
    return (<AccumulationChartComponent id="charts" ref={(pie) => (pie = pie)} legendSettings={{
            visible: true,
            reverse: true,
        }} useGroupingSeparator={true} enableSmartLabels={true} enableAnimation={true} tooltip={{ enable: true }}>
        <Inject services={[
            AccumulationLegend,
            PieSeries,
        ...
        <AccumulationSeriesCollectionDirective>
          <AccumulationSeriesDirective dataSource={data} xName="x" yName="y" innerRadius="20%" dataLabel={{
            ...
            position: 'Outside',
            name: 'x',
        }} radius="r"></AccumulationSeriesDirective>
        </AccumulationSeriesCollectionDirective>
