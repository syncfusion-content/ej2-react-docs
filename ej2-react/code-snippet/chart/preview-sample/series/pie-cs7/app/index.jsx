...
function App() {
    let pie;
    return <AccumulationChartComponent id='pie-chart' ref={pie => pie = pie} title='Mobile Browser Statistics' legendSettings={{ visible: false }} enableSmartLabels={true} enableAnimation={false} center={{ x: '60%', y: '60%' }} tooltip={{ enable: false, format: '${point.x} : <b>${point.y}%</b>' }}>
