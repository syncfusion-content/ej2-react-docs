...
function App() {
  ...
  // set html Attribute to multicolumn ComboBox input element
  const htmlAttributes = { title: "Select a employee" };

  return (
    // specifies the tag for render the MultiColumn ComboBox component
    <MultiColumnComboBoxComponent id="multicolumn" dataSource={empData} fields={fields} htmlAttributes={htmlAttributes}>
        <ColumnsDirective>
