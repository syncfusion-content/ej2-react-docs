...
function App() {
  ...
  // set placeholder to multicolumn ComboBox
  const waterMark = 'Select an employee';
  // set float label to multicolumn ComboBox
  const floatLabel = 'Auto';

  return (
    // specifies the tag for render the MultiColumn ComboBox component
    <MultiColumnComboBoxComponent id="multicolumn" dataSource={empData} fields={fields} placeholder={waterMark} floatLabelType={floatLabel}>
        <ColumnsDirective>
