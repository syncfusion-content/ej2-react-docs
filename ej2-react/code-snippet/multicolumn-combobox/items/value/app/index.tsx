...
function App() {
  ...
  // set value to multicolumn ComboBox input element
  const value: string = '1015';

  return (
    // specifies the tag for render the MultiColumn ComboBox component
    <MultiColumnComboBoxComponent id="multicolumn" dataSource={empData} fields={fields} value={value}>
        <ColumnsDirective>
