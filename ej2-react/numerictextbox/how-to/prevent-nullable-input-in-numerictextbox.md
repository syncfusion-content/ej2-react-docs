---
layout: post
title: How to prevent nullable input in React NumericTextBox | Syncfusion
description: Enforce a non-null value in the React NumericTextBox by preventing users from clearing the input on the value change event.
