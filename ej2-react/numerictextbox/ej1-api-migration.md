---
layout: post
title: EJ1 API Migration in React NumericTextBox | Syncfusion
description: Migrate the React NumericTextBox code from Essential JS 1 to Essential JS 2 using the renamed property and event mapping table.
...
# EJ1 API Migration in React NumericTextBox
