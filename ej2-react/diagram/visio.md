...
The React Diagram component supports exporting diagrams to Microsoft Visio format using the [`exportToVisio`](https://helpej2.syncfusion.com/react/documentation/api/diagram/index-default#exporttovisio) method. This method generates a **.vsdx** file and automatically downloads it through the browser.
