---
layout: post
title: Mentions in React AI AssistView | Syncfusion®
description: Render mentions in the Syncfusion® React AI AssistView prompt editor by configuring the trigger character, data source, filtering, popup, and templates.
platform: ej2-react
...
# Mentions in React AI AssistView
...
{% include code-snippet/ai-assistview/mentions/basic/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/basic/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/mention-char/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/mention-char/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
Use the `dataSource` property inside [`mentions`](../api/ai-assistview#mentions) provide a local collection, such as a string array or an object array, or use a `DataManager` instance to retrieve data locally or from a remote data source.

{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/data-source/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/data-source/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/fields/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/fields/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/query/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/query/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/filter-type/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/filter-type/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/highlight/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/highlight/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/show-mention-char/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/show-mention-char/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/display-template/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/display-template/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/popup-size/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/popup-size/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/item-template/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/item-template/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/no-records-template/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/no-records-template/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="index.jsx" %}
{% include code-snippet/ai-assistview/mentions/mention-select/app/index.jsx %}
{% endhighlight %}
{% highlight html tabtitle="index.tsx" %}
{% include code-snippet/ai-assistview/mentions/mention-select/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
