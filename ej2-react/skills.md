...
This guide introduces **Syncfusion React Skills**, a knowledge package that enables AI assistants (VS Code, Cursor, CodeStudio, etc.) to understand and generate accurate React code using official APIs, patterns, and theming guidelines.
...
Before installing Syncfusion<sup style="font-size:70%">&reg;</sup> React Agent Skills, ensure the following:
...
- Accurate guidance for adding and configuring Syncfusion<sup style="font-size:70%">&reg;</sup> React components
...
- Consistent design alignment across Syncfusion<sup style="font-size:70%">&reg;</sup> React components

## Installation

Install [Syncfusion<sup style="font-size:70%">&reg;</sup> React components skills](https://github.com/syncfusion/react-ui-components-skills.git) using the Skills CLI. Users can also explore available skills from the [marketplace](https://www.skills.sh/syncfusion).
...
Replace `<skill-name>` with the name of the skill you want to remove (for example, `syncfusion-react-grid`).
