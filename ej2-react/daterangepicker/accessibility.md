---
layout: post
title: Accessibility in React DateRangePicker | Syncfusion
description: Review the React DateRangePicker accessibility compliance for WCAG 2.2, Section 508, screen readers, RTL, and keyboard navigation.
