...
The React Dialog content is provided through the [`content`](https://ej2.syncfusion.com/react/documentation/api/dialog#content) property, which accepts both text and HTML strings, or by placing child JSX elements directly inside the `<DialogComponent>`.
...
* [How to add an icon to React Dialog buttons](./how-to/add-an-icons-to-dialog-buttons)
* [How to customize the React Dialog appearance](./how-to/customize-the-dialog-appearance)
