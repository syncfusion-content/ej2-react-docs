---
layout: post
title: Add icons to dialog buttons in React Dialog component | Syncfusion
description: Learn here all about adding icons to dialog buttons in Syncfusion React Dialog component of Syncfusion Essential JS 2 and more.
