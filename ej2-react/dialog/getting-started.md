...
The required styles for the React Dialog component are imported in the **src/App.css** file:
 
{% tabs %}
{% highlight css tabtitle="App.css" %}
 
@import "@syncfusion/ej2-tailwind3-theme/styles/React Dialog/index.css";
...
## Adding React Dialog component

Now, you can add the React Dialog component to your **src/App.jsx** file by importing and defining it within your application. Use the following code:
