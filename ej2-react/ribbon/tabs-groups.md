---
layout: post
title: Tabs and Groups in React Ribbon | Syncfusion
description: Learn how to organize the React Ribbon into a hierarchy of tabs, groups, and items to provide structured access to commands and related actions.
control: Ribbon
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
# Tabs and Groups in React Ribbon
