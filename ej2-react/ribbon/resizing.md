---
layout: post
title: Resizing in React Ribbon | Syncfusion
description: Learn how the React Ribbon resizes elements automatically when space changes, with support for custom resize order in Classic and Simplified modes.
control: Ribbon
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
