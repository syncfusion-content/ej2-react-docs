---
layout: post
title: Layouts in React Ribbon | Syncfusion
description: Learn how to customize the React Ribbon layout using the activeLayout property, with support for Classic, Simplified, and other layout modes.
control: Ribbon
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
