---
layout: post
title: File Menu in React Ribbon | Syncfusion
description: Learn how to add a built-in file menu in the React Ribbon with configurable menu items for actions like creating, opening, and saving documents.
control: Ribbon
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
