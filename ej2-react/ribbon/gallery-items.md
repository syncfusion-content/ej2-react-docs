---
layout: post
title: Gallery Items in React Ribbon | Syncfusion
description: Learn how to add a gallery in the React Ribbon to display a collection of related items such as icons, content, or images for quick user actions.
control: Ribbon
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
