---
layout: post
title: Backstage in React Ribbon | Syncfusion
description: Learn how to add a Backstage view in the React Ribbon to display application-level information and settings like user details and options pages.
control: Ribbon
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
