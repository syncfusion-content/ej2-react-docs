---
layout: post
title: Overview of React Pivot Table | Syncfusion
description: Explore the React Pivot Table overview and feature matrix for data analysis, data sources, layouts, performance, exporting, accessibility, and AI integration.
control: Pivot Table
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
# Overview of React Pivot Table

The Syncfusion<sup style="font-size:70%">&reg;</sup> React Pivot Table provides interactive tools for summarizing, organizing, exploring, and presenting multidimensional data. Use the following feature overview to identify the available capabilities, understand where they apply, and open the corresponding user guide topic for configuration details and limitations.

For supported React and browser versions, refer to the [system requirements](https://ej2.syncfusion.com/react/documentation/system-requirement).
...
| Touch interaction and mobile-device support | Built-in | Relational and OLAP | [Accessibility](./accessibility) and [touch support](https://www.syncfusion.com/react-components/react-pivot-table#touch-support) |
...
| High Contrast theme support | Configurable | Component UI | [Themes](https://ej2.syncfusion.com/react/documentation/appearance/theme) |
...
| Feature | Availability | Applies to | Learn more |
| --- | --- | --- | --- |
| Natural-language report configuration | Integration pattern | Operations allowed by the application's validated action contract | [Smart Pivot Table](./smart-pivot-table) |
| AI-assisted filtering, sorting, aggregation, layout, and chart changes | Integration pattern | Operations allowed by the application's validated action contract | [Supported AI operations](./smart-pivot-table#supported-ai-operations) |

## Quick links

* [Getting started](./getting-started)
* [Live Pivot Table demos](https://ej2.syncfusion.com/react/demos/#/tailwind3/pivot-table/overview)
* [Pivot Table API reference](https://ej2.syncfusion.com/react/documentation/api/pivotview)
