---
title: "Oracle Data Binding in React Pivotview component | Syncfusion"
component: "Pivot Table"
platform: ej2-React
description: "Learn how to bind data from a Oracle database in the Syncfusion React Pivot Table of Syncfusion Essential JS 2 and more."
---

# Oracle in EJ2 React Pivotview control
...
> Explore our React Pivot Table sample and ASP.NET Core Web Application to extract data from a Oracle database and bind to the Pivot Table in [this](https://github.com/SyncfusionExamples/how-to-bind-Oracle-database-to-pivot-table) GitHub repository.