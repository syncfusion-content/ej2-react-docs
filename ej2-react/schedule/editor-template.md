...
> Applicable validation rules can be referred from [form validation](https://helpej2.syncfusion.com/documentation/form-validator/#validation-rules) documentation.
