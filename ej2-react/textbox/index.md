...
* **[Floating Label](./groups/#with-icon-and-floating-label)**: Enables floating support to placeholder text of React TextBox.
* **[Sizing](./sizing/)**: Allows to set `Small` and `Normal` sized React TextBox.
