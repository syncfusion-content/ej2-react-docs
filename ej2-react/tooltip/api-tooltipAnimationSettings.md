...
Animation options that are common for both open and close actions of the React Tooltip.
...
It is used to apply the Animation effect on the React Tooltip, during open and close actions.
