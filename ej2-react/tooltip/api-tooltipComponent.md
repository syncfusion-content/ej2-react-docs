...
Represents the React React Tooltip component that displays a piece of information about the target element on mouse hover.
```
...
It is used to denote the target selector where the React Tooltip need to be displayed.
...
It is used to set the position of tip pointer on React Tooltip. When it sets to auto, the tip pointer auto adjusts within the space of target's length and does not point outside.
...
|------|------|-------------|
| animation (*optional*) |  [`TooltipAnimationSettings`](https://ej2.syncfusion.com/react/documentation/api-tooltipAnimationSettings.html) | Sets the specific animation when hiding React Tooltip from the screen. |
...
| animation (*optional*) |  [`TooltipAnimationSettings`](https://ej2.syncfusion.com/react/documentation/api-tooltipAnimationSettings.html) | Sets the specific animation, while showing the React Tooltip on the screen. |
