---
layout: post
title: Drag and Drop in React Tab | Syncfusion
description: Reorder Syncfusion React Tab items by drag and drop, or drag a tab item out of the bar to extract it as a separate panel.
