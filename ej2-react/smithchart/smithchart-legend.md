---
layout: post
title: Legend in React Smithchart | Syncfusion
description: Add and customize legends in the React Smithchart with position, alignment, custom coordinates, shape, size, padding, and toggle visibility.
