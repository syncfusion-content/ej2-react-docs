...
* `VisibleOnHover` – the navigator’s buttons are visible only when hovering over the React Carousel.

The following example demonstrates how to show or hide the navigators in the React Carousel.
...
In the React Carousel, you can show the previous and next buttons only on mouse hover using the [`buttonsVisibility`](https://ej2.syncfusion.com/react/documentation/api/carousel/index-default#buttonsvisibility) property. The following example illustrates how to show the navigators on mouse hover in the carousel.
...
Template option is provided to customize the indicators by using the [`indicatorsTemplate`](https://ej2.syncfusion.com/react/documentation/api/carousel/index-default#indicatorstemplate) property. The following example illustrates how to apply a template to indicators in the React Carousel.
...
A default indicator in a React Carousel is a set of dots that indicate the current position of the slide in the React Carousel. The Default indicator can be achieved by setting the [`indicatorsType`](https://ej2.syncfusion.com/react/documentation/api/carousel/index-default#indicatorstype) to `Default`.
...
A dynamic indicator in a React Carousel provides visual cues or markers that dynamically change or update to indicate the current position. The Dynamic indicator can be achieved by setting the [`indicatorsType`](https://ej2.syncfusion.com/react/documentation/api/carousel/index-default#indicatorstype) to `Dynamic`.
...
Template option is provided to customize the play button by using the [`playButtonTemplate`](https://ej2.syncfusion.com/react/documentation/api/carousel/index-default#playbuttontemplate) property. The following example shows how to apply a template to the play button in the React Carousel.
