---
layout: post
title: Accessibility in React Carousel | Syncfusion
description: WAI-ARIA roles, ARIA attributes for slides and controls, and configurable keyboard navigation for the Syncfusion React Carousel.
