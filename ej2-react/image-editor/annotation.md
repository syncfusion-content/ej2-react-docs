---
layout: post
title: Annotation in React Image Editor | Syncfusion
description: Add text, freehand drawings, and shapes like rectangles, ellipses, arrows, paths, and lines to images in the React Image Editor.
control: Annotation
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/image-editor/default-cs62/app/app.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/image-editor/default-cs62/app/app.tsx %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/image-editor/default-cs62/index.html %}
{% endhighlight %}
{% endtabs %}
