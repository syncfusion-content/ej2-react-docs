...
The [`drawRectangle`](https://ej2.syncfusion.com/react/documentation/api/image-editor/#drawrectangle) method in the React Image Editor component takes ten parameters to define the properties of the rectangle annotation: 
