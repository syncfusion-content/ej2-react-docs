...
The required styles for the React Image Editor component are imported in the **src/App.css** file. Create or open the **src/App.css** file if it does not exist, and add the following import:
...
## Adding React Image Editor component
...
> Refer to the [React Image Editor](https://www.syncfusion.com/react-components/react-image-editor) feature tour page for its groundbreaking feature representations. You can also explore our [React Image Editor component example](https://ej2.syncfusion.com/react/demos/#/tailwind3/image-editor/default) that shows how to render the React Image Editor.