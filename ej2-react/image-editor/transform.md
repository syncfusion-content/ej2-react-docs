---
layout: post
title: Transform in React Image Editor | Syncfusion
description: Rotate, flip, straighten, zoom, and pan images and their annotations with precise angle and zoom factor controls in React Image Editor.
control: Transform 
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
