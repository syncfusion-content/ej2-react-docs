...
Here is an example of straightening the image using the [`straightenImage`](https://ej2.syncfusion.com/react/documentation/api/image-editor/#straightenimage) method. 
