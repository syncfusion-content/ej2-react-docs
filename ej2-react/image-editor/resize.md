---
layout: post
title: Resize in React Image Editor | Syncfusion
description: Resize image dimensions for print, web, or custom layouts in the React Image Editor with optional aspect ratio preservation.
control: Resizing 
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
* isAspectRatio: Specifies a boolean value indicating whether the image should maintain its original aspect ratio during resizing. The aspect ratio is the proportional relationship between an image's width and height.
