---
layout: post
title: Getting Started with React Checkbox | Syncfusion
description: Learn how to get started with the Syncfusion React Checkbox control. Explore Vite setup, package installation, CSS themes, and basic usage.
...
# Getting Started with React Checkbox
...
The required styles for the React Checkbox component are imported in the **src/App.css** file:
...
## Adding React Checkbox component

Now, you can add the React Checkbox component to your **src/App.jsx** file by importing and defining it within your application.
...
> Refer to the [React Checkbox](https://www.syncfusion.com/react-components/react-checkbox) feature tour page for its groundbreaking feature representations. You can also explore our [React Checkbox component example](https://ej2.syncfusion.com/react/demos/#/tailwind3/button/checkbox) that shows how to render the React Checkbox in React.