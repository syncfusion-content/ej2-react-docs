...
The required styles for the Button component are imported in the **src/App.css** file:
...
Now, you can add the React Button component to your **src/App.jsx** file by importing and defining it within your application. Then, populate the Button with data using the [dataSource](https://ej2.syncfusion.com/react/documentation/api/auto-complete/index-default#datasource) property, which accepts an array of string values to display as suggestions. Use the following code:
