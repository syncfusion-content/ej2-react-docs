...
The Syncfusion<sup style="font-size:70%">&reg;</sup> React Gantt Chart component supports row cell spanning, allowing multiple cells in a row to merge into a single cell. This is useful for displaying shared information across rows without duplication.
