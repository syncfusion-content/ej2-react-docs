...
The Gantt Chart component has options to dynamically insert, delete, and update tasks in a project. The primary key column is necessary to manage the tasks and perform CRUD operations in Gantt. To define the primary key, set the [columns.isPrimaryKey](https://ej2.syncfusion.com/react/documentation/api/gantt/column#isprimarykey) property to `true` in the column.

To use CRUD, inject the [Edit](https://ej2.syncfusion.com/react/documentation/api/gantt#editmodule) module into the Gantt Chart component.
