---
layout: post
title: Selection in React 3D Chart | Syncfusion
description: Learn how to select series or data points in the Syncfusion React 3D Chart on mouse click with selection modes for series, point, or cluster.
control: Selection
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
