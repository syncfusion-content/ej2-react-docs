---
layout: post
title: Bar Chart in React 3D Chart | Syncfusion
description: Learn how to render a 3D bar chart in Syncfusion React 3D Chart to compare values across categories with a horizontal cylindrical look.
control: Bar Chart
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
