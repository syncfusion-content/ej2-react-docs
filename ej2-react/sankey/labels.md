---
layout: post
title: Labels in React Sankey Chart | Syncfusion
description: Learn how to configure and customize labels on nodes and links in the Syncfusion React Sankey Chart Component using labelSettings.
control: Labels
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
