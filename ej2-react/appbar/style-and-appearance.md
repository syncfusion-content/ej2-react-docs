---
layout: post
title: Style and Appearance in React AppBar | Syncfusion
description: CSS class reference plus the `cssClass` and `htmlAttributes` properties for theming the Syncfusion React AppBar.
