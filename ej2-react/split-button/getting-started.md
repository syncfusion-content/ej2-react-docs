...
@import "@syncfusion/ej2-tailwind3-theme/styles/split-button/index.css";
...
Now, you can add the React SplitButton component to your **src/App.jsx** file by importing and defining it within your application. Then, populate the SplitButton with data using the [dataSource](https://ej2.syncfusion.com/react/documentation/api/split-button/index-default#datasource) property, which accepts an array of string values to display as suggestions. Use the following code:
