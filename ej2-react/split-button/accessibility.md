---
layout: post
title: Accessibility in React Split Button | Syncfusion
description: Learn how the React Split Button meets WCAG 2.2, Section 508, and ADA standards. Includes WAI-ARIA roles, keyboard interaction, and validation tools.
