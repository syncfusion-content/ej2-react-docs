...
| **React UI Builder** | Agent skill that helps accelerate UI creation with Syncfusion components from natural-language prompts | Building complete UIs quickly without writing the code yourself |
...
**Option 3: Install React UI Builder (agentic UI builder)**

The [Syncfusion® React UI Builder](https://ej2.syncfusion.com/react/documentation/agentic-ui-builder) is an agent skill that goes beyond snippets and code suggestions — it helps speed up the development process by building full React components and pages from a natural-language description. It detects your project setup, selects the right Syncfusion components, injects the required feature modules, applies the chosen theme, and produces accessible, responsive, typed code.
...
For installation steps, supported targets, and how to use the agent, see the [React UI Builder documentation](https://ej2.syncfusion.com/react/documentation/agentic-ui-builder#installation).
...
| Generating full UIs from a prompt | IDE AI + React UI Builder |
...
| Generate a full UI from a prompt | Use React UI Builder |
