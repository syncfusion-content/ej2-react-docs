---
layout: post
title: AI Coding Assistants with Syncfusion React Components | Syncfusion
description: Master AI Coding Assistants with Syncfusion React components using MCP Server and skills. Learn which approach fits the workflow and get better results.
platform: ej2-react
...
# AI Coding Assistants Development with Syncfusion React Components
...
> **Note:** Using Component Skills and MCP Server together gives the AI both curated implementation patterns and live documentation context. This combination helps generate more accurate, consistent, and up-to-date Syncfusion React code.
