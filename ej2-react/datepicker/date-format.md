---
layout: post
title: Date Format in React DatePicker | Syncfusion
description: Customize the date format in the React DatePicker with the format property to render dates in yyyy-MM-dd or culture-specific patterns.
control: Date format 
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
# Date Format in React DatePicker
