...
| aria-autocomplete | This attribute contains the 'both' value to indicate that a list of options shows and the currently selected suggestion also shows inline. |
...
| <kbd>Esc(Escape)</kbd> | Closes the popup list when it is in an open state and removes the selection. |
