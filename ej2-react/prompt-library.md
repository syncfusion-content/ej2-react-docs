...
* Run the prompt using either of the following AI tools:
  ...
  * **Skills**: Skills can also run automatically based on the query, or can be called explicitly using the `/syncfusion-react-grid` skill.
...
How do I enable paging and sorting in the Syncfusion React Grid?
{% endpromptcard %}
...
What's the code to implement full CRUD operations in Syncfusion React Grid?
{% endpromptcard %}
...
Show me how to enable range selection in a Syncfusion React Chart.
{% endpromptcard %}
{% promptcard Chart Types Overview %}
What chart types are available in Syncfusion React Chart, and how do I configure them?
{% endpromptcard %}
...
Enable print functionality for a Syncfusion React Chart component.
{% endpromptcard %}
...
How do I inject required modules into the Syncfusion React Schedule component?
{% endpromptcard %}
...
How can I configure timezone support in the Syncfusion React Schedule?
{% endpromptcard %}
...
How do I bind local or remote data to the Syncfusion React Kanban board?
{% endpromptcard %}
{% promptcard Sorting %}
...
How do I integrate a React form and validate input in RichTextEditor?
{% endpromptcard %}
...
How do I enable date range selection in the Syncfusion React Calendar?
{% endpromptcard %}
