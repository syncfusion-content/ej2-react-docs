...
{% include code-snippet/treemap/code-path/selectionAndHighlight-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/treemap/code-path/selectionAndHighlight-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
