---
layout: post
title: Templates in React Breadcrumb | Syncfusion
description: Customize individual Syncfusion React Breadcrumb items and the separator between them with `itemTemplate` and `separatorTemplate`.
control: Breadcrumb 
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
