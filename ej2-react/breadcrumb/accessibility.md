---
layout: post
title: Accessibility in React Breadcrumb | Syncfusion
description: WAI-ARIA roles, `aria-label` and `aria-disabled` attributes, and full keyboard navigation support for the Syncfusion React Breadcrumb.
control: Breadcrumb
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
