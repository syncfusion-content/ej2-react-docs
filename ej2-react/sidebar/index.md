...
1. **[Target](../sidebar/custom-context)**: React Sidebar can be initialized in any HTML element other than the body element.
...
3 . **[Auto close](../sidebar/auto-close)**: Allows to set the React Sidebar in an expanded or collapsed state only in certain resolutions.
