---
layout: post
title: Accessibility in React Sidebar | Syncfusion
description: Built-in WAI-ARIA `complementary` landmark role, `aria-label` and `aria-expanded` patterns, and screen reader support for the Syncfusion React Sidebar.
