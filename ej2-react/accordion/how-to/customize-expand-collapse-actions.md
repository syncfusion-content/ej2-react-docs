---
layout: post
title: How to handle expand/collapse in React Accordion | Syncfusion
description: Coordinate expand and collapse behavior across Syncfusion React Accordion panes using the `created`, `expanding`, and `expanded` events.
...
# How to handle expand/collapse in React Accordion

React Accordion component supports customizing the expand or collapse animation action behavior. You can manually change the expand animation action performed after the collapse animation operation performed on already expand pane when the expand icons are clicked.

By default, the React Accordion component pane is expanded or collapsed, when click the expand or collapse icon. It is not affected on already expand pane.
