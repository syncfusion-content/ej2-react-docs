---
layout: post
title: Migration from EJ1 in React Toolbar | Syncfusion
description: Side-by-side mapping of Essential JS 1 Toolbar APIs and their equivalent Syncfusion React Toolbar replacements and usage.
...
# Migration from EJ1 in React Toolbar
...
|HtmlAttributes | **Property:** items[0].htmlAttributes <br/> `<EJ.Toolbar id="toolbar" items={this.items}> </EJ.Toolbar>`<br/> <br/> constructor(props: {}) {<br/> this.items = [{ htmlAttributes: {  } }];}| **Property:** items[0].htmlAttributes <br/> `<ToolbarComponent id="toolbar" items={this.items}> </ToolbarComponent>`<br/> <br/> constructor(props: {}) {<br/> this.items = [{ htmlAttributes: {  } }];}|
...
|Sprite CssClass | **Property:** items[0].spriteCssClass <br/> `<EJ.Toolbar id="toolbar" items={this.items}> </EJ.Toolbar>`<br/> <br/>  constructor(props: {}) {<br/> this.items = [{ spriteCssClass: 'e-class' }]; } |<b>Not Applicable</b> |
...
|Text | **Property:** items[0].text <br/> `<EJ.Toolbar id="toolbar" items={this.items}> </EJ.Toolbar>`<br/> <br/> constructor(props: {}) {<br/> this.items = [{ text: 'Cut' }]; } | **Property:** items[0].text <br/> `<ToolbarComponent id="toolbar" items={this.items}> </ToolbarComponent>`<br/> <br/> constructor(props: {}) {<br/> this.items = [{ text: 'Cut' }];} |
|TooltipText | **Property:** items[0].tooltipText <br/> `<EJ.Toolbar id="toolbar" items={this.items}> </EJ.Toolbar>`<br/> <br/> constructor(props: {}) {<br/> this.items = [{ tooltipText: 'Cut' }];} | **Property:** items[0].tooltipText <br/> `<ToolbarComponent id="toolbar" items={this.items}> </ToolbarComponent>`<br/> <br/> constructor(props: {}) {<br/> this.items = [{ tooltipText: 'Cut' }]; } |
...
|RemoveItemById |**Method:** removeItemById(id)<br/> `<EJ.Toolbar id="toolbar" > </EJ.Toolbar>`<br/> <br/> var obj=$('#toolbar').ejToolbar('instance')<br/>obj.removeItemById('left');|<b>Not Applicable</b>|
...
|Disable Item | **Method:** disableItem(element)<br/> `<EJ.Toolbar id="toolbar" > </EJ.Toolbar>`<br/> <br/> var obj=$('#toolbar').ejToolbar('instance')<br/>obj.disableItem(ele);| **Method:** enableItems(items, false)<br/> `<ToolbarComponent id="toolbar" ref = {(scope) => {this.ToolbarObj = scope}}> </ToolbarComponent>`<br/> <br/>  constructor(props: {}) {<br/> this.ToolbarObj.enableItems([], false); }|
...
| Hide item |<b>Not Applicable</b>| **Method:** hideItem(index, true)<br/> `<ToolbarComponent id="toolbar" ref = {(scope) => {this.ToolbarObj = scope}}> </ToolbarComponent>`<br/> <br/>  constructor(props: {}) {<br/> this.ToolbarObj.hideItem(0, true); }|
...
|itemLeave | **Event:** itemLeave<br/> `<EJ.Toolbar id='toolbar' itemLeave={this.onitemLeave}></EJ.Toolbar>`<br/> <br/> onitemLeave(event){  }  | <b>Not Applicable</b> |
...
|EnableSeparator | **Property:** enableSeparator <br/> `<EJ.Toolbar id="toolbar" enableSeparator={false} > </EJ.Toolbar>`| <b>Not Applicable</b> |
...
|HtmlAttributes | **Property:** htmlAttributes <br/> `<EJ.Toolbar id="toolbar" htmlAttributes={this.attributes} > </EJ.Toolbar>`<br/> <br/> constructor(props: {}) {<br/> this.attributes = {class: "my-class" };}| <b>Not Applicable</b> |
|Hide | **Property:** hide() <br/> `<EJ.Toolbar id="toolbar" hide={true}> </EJ.Toolbar>` | <b>Not Applicable</b> |
|Orientation | **Property:** orientation <br/> `<EJ.Toolbar id="toolbar" orientation="horizontal" > </EJ.Toolbar>`| <b>Not Applicable</b> |
|OverflowMode | **Property:** responsiveType <br/> `<EJ.Toolbar id="toolbar" responsiveType="popup" > </EJ.Toolbar>`|  **Property:** overflowMode <br/> `<ToolbarComponent id="toolbar" overflowMode="popup" > </ToolbarComponent>` |
...
|Responsive | **Property:** isResponsive <br/> `<EJ.Toolbar id="toolbar" isResponsive={true} > </EJ.Toolbar>` |<b>Not Applicable</b>|
|ShowRoundedCorner | **Property:** showRoundedCorner <br/> `<EJ.Toolbar id="toolbar" showRoundedCorner={true} > </EJ.Toolbar>`| <b>Not Applicable</b> |
|Width | **Property:** width <br/> `<EJ.Toolbar id="toolbar" width="600" > </EJ.Toolbar>`|  **Property:** width <br/> `<ToolbarComponent id="toolbar" width="600" > </ToolbarComponent>` |
...
|BeforeCreate | <b>Not Applicable</b> | <b>Not Applicable</b> |
