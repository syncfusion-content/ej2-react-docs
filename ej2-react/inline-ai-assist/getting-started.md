...
Import the required theme files in your `src/App.css` (or equivalent) to apply styling. The example below uses the Material theme; other themes are available.
