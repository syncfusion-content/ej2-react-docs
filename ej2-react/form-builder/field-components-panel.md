---
layout: post
title: Field Components Panel in React Form Builder component | Syncfusion
description: Learn how to use the Field Components Panel in the React Form Builder component to create forms using a drag-and-drop interface.
platform: ej2-react
...
# Field Components Panel in React Form Builder component
