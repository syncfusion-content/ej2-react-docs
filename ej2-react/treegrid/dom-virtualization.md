---
layout: post
title: React Tree Grid DOM Virtualization | Syncfusion
description: Learn how DOM virtualization in React Tree Grid improves large dataset performance through viewport rendering and efficient scrolling.
...
# DOM Virtualization in React Tree Grid

DOM virtualization is a rendering technique that improves performance by displaying only the visible portion of data in the viewport, plus a configurable buffer zone. The Syncfusion<sup style="font-size:70%">&reg;</sup> React Tree Grid implements DOM virtualization to handle datasets ranging from thousands to millions of rows while maintaining smooth Tree Grid interactions.
...
To enable DOM virtualization in the React Tree Grid, you need to inject the **DomVirtualization** module. This module is responsible for managing the DOM pooling behavior and optimizing the rendering of data to enhance performance.

DOM virtualization can be enabled by setting the [enableDomVirtualization](../../api/Tree Grid#enabledomvirtualization) property to `true`. 

```ts
import { TreeGridComponent, ColumnsDirective, ColumnDirective, Inject } from '@syncfusion/ej2-react-Tree Grids';
import { DomVirtualization } from '@syncfusion/ej2-react-Tree Grids';

function App() {
  return (
    <TreeGridComponent enableDomVirtualization={true} height={500} childMapping='subtasks'>
      <Inject services={[DomVirtualization]} />
      <ColumnsDirective>
        <ColumnDirective field='taskID' headerText='taskID' width='100' />
        <ColumnDirective field='taskName' headerText='taskName' width='150' />
      </ColumnsDirective>
    </TreeGridComponent>
  );
}
...
{% include code-snippet/treegrid/dom-virtualization-cs1/app/App.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="App.tsx" %}
{% include code-snippet/treegrid/dom-virtualization-cs1/app/App.tsx %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.tsx" %}
{% include code-snippet/treegrid/dom-virtualization-cs1/app/datasource.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "page.domainurl/code-snippet/treegrid/dom-virtualization-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="App.jsx" %}
{% include code-snippet/treegrid/dom-virtualization-cs2/app/App.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="App.tsx" %}
{% include code-snippet/treegrid/dom-virtualization-cs2/app/App.tsx %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.tsx" %}
{% include code-snippet/treegrid/dom-virtualization-cs2/app/datasource.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "page.domainurl/code-snippet/treegrid/dom-virtualization-cs2" %}
