...
* A stable internet connection during installation — the web installer downloads the selected components at install time.
* Windows 7 SP1 or later, with administrator privileges required to run the installer.
...
1. Visit the [Download Free Trial](https://www.syncfusion.com/downloads) page and select the **JavaScript - EJ2** product to start the evaluation.
...
2. After completing the form or signing in with a registered Syncfusion<sup style="font-size:70%">&reg;</sup> account, download the JavaScript - EJ2 trial installer from the confirmation page.
    ...
    ![Trial download confirmation](images/trial-confirmation.png)

3. Trial installers are available only for the latest product version.

4. The Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript - EJ2 trial installer can be unlocked using a trial unlock key or the registered Syncfusion<sup style="font-size:70%">&reg;</sup> account credentials.
...
1. Start the 30-day free trial for JavaScript - EJ2 from the [Start Trial](https://www.syncfusion.com/account/manage-trials/start-trials) page in the Syncfusion account.
...
3. Select the **JavaScript - EJ2** product to begin the trial.
    ...
    > If an active trial exists and has not expired, the trial cannot be restarted for the same product.

4. After starting the trial, visit the [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page to download the latest trial installer. Generate the [unlock key](https://www.syncfusion.com/kb/8069/how-to-generate-unlock-key-for-essentials-studio-products) and the [license key](https://ej2.syncfusion.com/react/documentation/licensing/license-key-registration) from this page before the trial expires. Active trial products are listed on the [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page.
...
3. Click the **Download** button (labeled 1 in the screenshot below) to obtain the installer for the selected product.

4. The most recent installer version is downloaded by default.

5. To access older installers, open **Downloads Older Versions** (labeled 2 in the screenshot below).

6. For additional platforms or add-on installers, choose **More Download Options** (labeled 3 in the screenshot below).

    ![Licensed downloads page](images/license-download.png)

## Next steps

After downloading the web installer, refer to the [Web Installer Installation Guide](https://ej2.syncfusion.com/react/documentation/installation/web-installer/installation-using-web-installer) for step-by-step installation instructions.