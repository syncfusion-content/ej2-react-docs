...
* At least 2 GB of free disk space for the downloaded archive and installed content.
...
3. Click the **Download** button (labeled 1 in the screenshot below) to download the installer for the chosen product.
...
After downloading the installer, refer to the [Offline Installer Installation Guide](https://ej2.syncfusion.com/react/documentation/installation/offline-installer/installation-using-offline-installer) for step-by-step installation instructions.