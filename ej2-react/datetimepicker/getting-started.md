...
@import "@syncfusion/ej2-tailwind3-theme/styles/datetimepicker/index.css";
...
Now, you can add the React DateTimePicker component to your **src/App.jsx** file by importing and defining it within your application. Then, populate the DateTimePicker with data using the [dataSource](https://ej2.syncfusion.com/react/documentation/api/datetimepicker/index-default#datasource) property, which accepts an array of string values to display as suggestions. Use the following code:
