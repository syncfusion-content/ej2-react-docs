---
layout: post
title: Filtering in React Query Builder UI | Syncfusion
description: Create and delete filter rules and groups in the React Query Builder UI interactively or with addRules, deleteRules, addGroups, and deleteGroups methods.
