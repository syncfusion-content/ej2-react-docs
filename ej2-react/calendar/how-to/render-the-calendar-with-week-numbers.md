...
Enable week numbers in the Calendar by setting the [`weekNumber`](https://ej2.syncfusion.com/react/documentation/api/calendar#weeknumber) property to `true`. By default, week numbers are calculated using the **ISO-8601** rule, where week 1 is the week containing the first Thursday of the year.

**API**

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `weekNumber` | `Boolean` | `false` | Displays week numbers in a leading column of the Calendar. |
...
The following example demonstrates the Calendar with week numbers enabled.
