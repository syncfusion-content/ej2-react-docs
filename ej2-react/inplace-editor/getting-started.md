...
yarn add @syncfusion/ej2-react-inplace-editor
...
The required styles for the React In-place Editor component are imported in the **src/App.css** file:

{% tabs %}
{% highlight css tabtitle="App.css" %}

@import "@syncfusion/ej2-tailwind3-theme/styles/inplace-editor/index.css";
...
## Add the React In-place Editor component

Now, you can add the React In-place Editor component to your **src/App.jsx** file by importing and defining it within your application. Use the following code:
...
function App() {
    // defines the model for the React In-place Editor
    const model = { placeholder: 'Enter employee name' };
    return (
        // specifies the tag for rendering the React In-place Editor component
