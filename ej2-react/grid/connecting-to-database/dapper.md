...
description: React Grid Dapper integration supports using Dapper in .NET backends with query patterns that fetch, update, and persist grid data efficiently.
platform: ej2-react
control: grid
