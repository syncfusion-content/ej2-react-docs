...
The React DataGrid enables customized header and footer sections to be added in exported PDF documents. This feature supports custom text, page numbers, lines, page size configuration, and orientation changes for header and footer sections.

## Adding text in header and footer

The React DataGrid supports adding custom text to the `header` or `footer` sections of exported PDF documents.
...
The React DataGrid supports inclusion of images in the header and footer sections of exported PDF documents. This feature enables addition of custom logos, branding elements, or other relevant images to enhance document presentation.
