...
This guide outlines the steps to integrate routing in a React application that uses the Syncfusion<sup style="font-size:70%">&reg;</sup> [React Data Grid](https://www.syncfusion.com/react-components/react-data-grid) component.
