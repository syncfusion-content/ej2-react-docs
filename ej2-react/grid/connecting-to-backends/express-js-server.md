...
description: Learn how to connect Syncfusion React Data Grid to Express.js backend for server-side paging, sorting, filtering, searching, and CRUD operations.
control: UrlAdaptor
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
4. [Perform CRUD operations in server](#perform-crud-operations-in-server) - Handle server-side CRUD actions.
...
8. [Complete sample repository](#complete-sample-repository) - Explore a complete working sample on GitHub.
