...
| 2 | Integrate the [React Data Grid](https://www.syncfusion.com/react-components/react-data-grid) with HotChocolate GraphQL API | [View](#integrating-syncfusion-react-grid-with-hotchocolate-graphql) |
...
The HotChocolate GraphQL backend acts as the central data service, handling queries and mutations that power the [React Data Grid](https://www.syncfusion.com/react-components/react-data-grid).
...
[[React Data Grid](https://www.syncfusion.com/react-components/react-data-grid) with HotChocolate GraphQL Sample](https://github.com/SyncfusionExamples/ej2-react-grid-samples/tree/master/connecting-to-backends/syncfusion-reactgrid-with-hotchocolate-graphQL-server)
