...
| 2 | Create and configure the React application with the Syncfusion<sup style="font-size:70%">&reg;</sup> React Grid | [View](#integrate-syncfusion-react-grid-with-django-rest-framework-post-request) |
