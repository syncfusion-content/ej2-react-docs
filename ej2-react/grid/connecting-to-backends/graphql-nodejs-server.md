...
| 2 | Integrate the [React Data Grid](https://www.syncfusion.com/react-components/react-data-grid) with the GraphQL API | [View](#integrating-syncfusion-react-grid-with-graphql) |
...
The application now provides a fully integrated "product" management workflow using the [React Data Grid](https://www.syncfusion.com/react-components/react-data-grid) connected to a Node.js GraphQL backend.
