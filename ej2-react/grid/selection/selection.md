...
> * The `persistSelection` feature is not supported for cell selections in the [React Data Grid](https://www.syncfusion.com/react-components/react-data-grid) component.
