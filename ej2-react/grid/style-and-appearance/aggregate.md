...
The appearance of aggregate elements in the React DataGrid component can be customized using CSS. Below are examples for customizing the aggregate root element and the aggregate cell elements.
