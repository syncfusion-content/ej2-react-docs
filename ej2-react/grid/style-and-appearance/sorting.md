...
You can customize the appearance of the sorting icons and multi sorting icons in the Syncfusion React Grid component using CSS. You can use the available Syncfusion [icons](https://ej2.syncfusion.com/react/documentation/appearance/icons#material) based on your theme. Here's how to do it:
