---
layout: post
title: Getting Started with React Radio Button | Syncfusion
description: Learn how to get started with the Syncfusion React Radio Button control. Explore Vite setup, package installation, CSS themes, and basic usage.
...
# Getting Started with React Radio Button

This section explains the steps required to create a simple React Radio Button component and demonstrate its basic usage in a React environment.
...
The required styles for the React Radio Button component are imported in the **src/App.css** file:
...
## Add the React Radio Button component

Now, you can add the React RadioButton component to your **src/App.jsx** file by importing and defining it within your application. Use the following code:
