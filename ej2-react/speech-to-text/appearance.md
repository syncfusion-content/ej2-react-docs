---
layout: post
title: Appearance in React Speech To Text | Syncfusion®
description: Customize the Syncfusion React Speech To Text button with start/stop content, icons, tooltips, positioning, and CSS classes like e-primary or e-outline.
